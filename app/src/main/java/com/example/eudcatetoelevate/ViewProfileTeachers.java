...
public class ViewProfileTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_profile_teachers);
        profilemessage = findViewById(R.id.student_home_profile_msg_teacher);
        name=findViewById(R.id.student_home_info_name_teacher);
        emailid=findViewById(R.id.student_home_info_email_teacher);
        phoneno=findViewById(R.id.student_home_info_phoneno_teacher);
        city=findViewById(R.id.student_home_info_city_teacher);
        qualification=findViewById(R.id.student_home_info_qualification_teacher);
        collegename=findViewById(R.id.student_home_info_clgname_teacher);
        passingyear=findViewById(R.id.student_home_info_passingyear_teacher);
        fieldofinterest=findViewById(R.id.student_home_info_INTEREST_teacher);
        personal =findViewById(R.id.student_home_profile_personal_teacher);
        quadet = findViewById(R.id.student_home_profile_qualification_teacher);
        ...
        profileRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ViewProfileTeachers.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
