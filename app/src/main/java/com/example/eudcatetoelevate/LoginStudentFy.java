    ...
    FirebaseAuth.AuthStateListener authStateListener = new FirebaseAuth.AuthStateListener() {
        ...
        public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
            ...
            if (firebaseUser != null) {
                ...
                pd.setTitle("Logging As Student");
                ...
                Toast.makeText(LoginStudentFy.this, "It Seems that You haven't logged in!", Toast.LENGTH_SHORT).show();
            }
        }
    };
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    if (mAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        useridRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (Objects.equals(email, loginEmail)) {
                                                    ...
                                                    Toast.makeText(LoginStudentFy.this, "You are not authorized as Student Please Log in using First Year Account ", Toast.LENGTH_SHORT).show();
                                                    finish();
                                                    pd.dismiss();
                                        ...
                                        Toast.makeText(LoginStudentFy.this, "Email id is not yet Verified", Toast.LENGTH_SHORT).show();
