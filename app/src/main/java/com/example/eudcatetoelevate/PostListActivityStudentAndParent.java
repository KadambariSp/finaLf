...
public class PostListActivityStudentAndParent extends AppCompatActivity {
  ...
  /*  private void showDeleteDataDialog(final String currentTitle, final String currentImage) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menustud,menu);
        MenuItem item=menu.findItem(R.id.action_search_stud);
